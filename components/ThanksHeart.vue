<template>
  ...
  <div class="container">
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      x="0px" y="0px" viewBox="0 0 269 264" style="enable-background:new 0 0 269 264;" xml:space="preserve">
      <g>
...
onMounted(() => {
  document.querySelectorAll('[id*="Particle"]').forEach((el) => {
    const randomDuration = Math.floor(Math.random() * 1000) + 1000 // Between 1000ms and 2000ms
    ;(el as unknown as HTMLElement).style.setProperty('--duration', `${randomDuration}ms`)
  })
})
</script>
...
[id*=Particle] {
  ...
  animation-fill-mode: forwards;
  animation-delay: calc($duration / 4);
}
